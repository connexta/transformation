...
pipeline {
    ...
    stages {
        ...
        stage('Incremental Build') {
            ...
            steps {
                withMaven(maven: 'Maven 3.5.4', jdk: 'jdk11', globalMavenSettingsConfig: 'default-ion-global-settings', mavenSettingsConfig: 'ion-maven-settings', mavenOpts: '${LINUX_MVN_RANDOM}') {
