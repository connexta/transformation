...
pipeline {
    ...
    stages {
        ...
        stage('Incremental Build') {
            ...
            steps {
                withMaven(maven: 'Maven 3.5.4', jdk: 'jdk11', globalMavenSettingsConfig: 'ion-global-settings-no-mirror', mavenSettingsConfig: 'ion-maven-settings', mavenOpts: '${LINUX_MVN_RANDOM}') {
